    ...
    <button type="button" @click="goBack">
        <svg xmlns="http://www.w3.org/2000/svg" class="dark:fill-current  dark:text-white" version="1.0" width="30px"
            ...
            <g transform="translate(0.000000,512.000000) scale(0.100000,-0.100000)" stroke="none">
                ...
                <path
                    d="M2270 3690 c-33 -16 -170 -146 -528 -503 -266 -265 -496 -502 -512 -526 -40 -60 -46 -101 -25 -159 15 -40 90 -120 504 -535 267 -269 506 -503 531 -520 117 -82 273 -1 272 143 -1 27 -8 61 -16 77 -8 15 -168 181 -355 368 l-341 340 992 5 c899 5 996 7 1023 22 64 35 97 90 97 158 0 68 -33 123 -97 158 -27 15 -124 17 -1023 22 l-992 5 341 340 c187 187 347 353 355 368 21 40 20 120 -3 158 -49 85 -141 117 -223 79z" />
            </g>
        </svg>
    </button>
</template>
