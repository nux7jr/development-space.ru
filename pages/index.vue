    ...
    <section>
        <div class="p-4">
            <div class="grid grid-cols-1 gap-4 list-none lg:grid-cols-3 lg:grid-rows-3 xl:grid-cols-4 xl:grid-rows-4">
                <div
                    class="lg:row-span-2 ring-1 dark:ring-white/10 ring-primary/5 bg-white dark:bg-secondary shadow-xl dark:shadow-thick rounded-3xl p-8">
                    ...
                    <p class="mt-4 text-sm text-zinc-500 dark:text-zinc-400 font-light lg:text-xl">
                        В цифровом мире я создаю интерфейсы и погружаюсь в тонкости кодирования.
                        <br />
                        <br />
                        За пределами экранов я нахожу утешение и радость, катаясь на сноуборде.
                    </p>
                </div>
                <div
                    class="ring-1 dark:ring-white/10 ring-primary/5 rounded-3xl justify-between shadow-xl dark:shadow-thick items-center flex flex-col p-8 h-full bg-white  dark:bg-secondary">
                    <div class="w-full">
                    ...
                    <div class="grid mt-4 grid-cols-4 md:grid-cols-8 lg:grid-cols-4 gap-y-4 gap-4 justify-center w-full">
                        <a href="mailto:nux7jr@gmail.com"
                        ...
                        <a href="https://github.com/nux7jr"
                            class="flex items-center justify-center aspect-square shadow-xl dark:shadow-thick hover:bg-zinc-100 dark:hover:bg-primary ring-1 bg-zinc-50 dark:ring-white/10 ring-primary/5 dark:bg-tertiary rounded-lg hover:ring-primary/5 dark:hover:ring-white/20 duration-300 group transition-all h-12 w-12">
                            <svg xmlns="http://www.w3.org/2000/svg"
                ...
                <NuxtLink to="/blog"
                    ...
                    <div>
                        <p class="ext-xl tracking-tight font-medium text-primary dark:text-white md:text-6xl">
                            DEVELOPMENT-SPECE
                        </p>
                ...
                <div
                    ...
                    <div>
                        ...
                        <p class="mt-4 text-sm text-zinc-500 dark:text-zinc-400 md:max-w-xs lg:max-w-none">
                            Откройте двери, чтобы изучить богатое полотно моего профессионального пути и достижений.
                        </p>
                    </div>
                ...
                <a href="https://www.figma.com/@mikeandreuzza"
                    ...
                    <svg class="w-24 h-24 lg:w-48 xl:h-64 xl:w-64 lg:h-48" viewBox="0 0 90 90" fill="none"
                        ...
                        <defs>
                            <clipPath id="clip0_1_136">
                                <rect width="38" height="57" fill="white" transform="translate(26 17)"></rect>
                            </clipPath>
                        </defs>
                    </svg>
                ...
                <a href="https://lexingtonthemes.com/"
                    ...
                    <div class="-mr-24">
                        <img src="/images/index/lexington.png"
                            class="rounded-2xl object-cover ring-1 h-64 w-full lg:h-auto dark:ring-white/10 ring-primary/5 bg-tertiary"
                            alt="" />
                    </div>
                    <div class="mt-8">
                        <div class="flex flex-wrap">
                            <div class="flex items-center ml-6 text-sm font-medium text-primary dark:text-white">
                                <svg viewBox="0 0 256 154" aria-label="Tailwind CSS"
                                    class="flex-none w-4 h-4 stroke-current" width="64" height="64"
                        ...
                        <p class="ext-xl tracking-tight font-medium text-primary dark:text-white md:text-6xl mt-6">
                            Про этот блог
                        </p>
                        <p class="mt-4 text-sm text-zinc-500 dark:text-zinc-400 font-light">
                            Расскажу как я делал этот блог, решил взять Tailwind CSS как основу для дизайна. Он включает в
                            себя профессионально созданный набор стандартных настроек по умолчанию, но буквально все можно
                            настроить - от цветовой палитры до шкалы интервалов до теней прямоугольников и курсора мыши.
                        </p>
                    </div>
                </a>
                <div
                    ...
                    <div class="relative p-8 text-center w-full">
                        <p class="text-xl tracking-tight font-medium text-primary dark:text-white md:text-6xl">
                            Подписаться <span class="lg:block">на мою рассылку</span>
                        </p>
                        <form class="mt-6 sm:flex w-full lg:max-w-sm mx-auto">
                            <label for="email-address" class="sr-only">Ваш email</label>
                            ...
                            <div class="mt-4 sm:ml-2 sm:mt-0 sm:flex-shrink-0">
                                <button type="submit"
                                    class="text-sm py-2 w-full px-4 h-12 font-semibold focus:ring-2 rounded-lg bg-primary dark:bg-white dark:text-primary dark:hover:text-white hover:text-primary dark:hover:bg-white/5 hover:bg-primary/10 text-white flex duration-200 focus:ring-offset-2 focus:ring-inline-flex items-center justify-between">Подписаться</button>
                            </div>
                        </form>
                    </div>
                </div>
                    ...
                    <div class="md:grid md:grid-cols-2 gap-6 lg:grid-cols-1">
                        <div class="mt-4">
                            <p class="text-sm text-pink-500 dark:text-pink-400">
                                Личный блог открывает возможности для установления связей с людьми со схожими интересами.
                                Диалог автора с читателями блога порой интереснее самого поста, а знакомство с
                                представителями различных ниш может привести к деловому сотрудничеству
                            </p>

                        </div>
                        <div class="mt-4">
                            <p class="text-sm text-orange-500 dark:text-orange-300">
                                Я совсем не коучем. Просто хочу обмениваться опытом с подписчиками или сделать из блога
                                площадку для взаимопомощи и поддержки.
                            </p>
                ...
                <div
                    ...
                    <p class="text-xl tracking-tight font-medium text-primary dark:text-white md:text-3xl">
                        Наши добродетели и наши недостатки неразделимы, как сила и материя. Когда они расходятся, человека
                        больше не существует
                        <br />
                        <br />
                        С этим принципом вы можете дожить до того, что увидите рукотворные ужасы за гранью вашего понимания
                    </p>
                    <p class="text-primary dark:text-white mt-4">Никола Тесла</p>
                </div>
            </div>
        </div>
    </section>
