                        ...
                        <form action="#" method="GET" class="hidden lg:block lg:pl-3.5">
                            ...
                            <div class="relative mt-1 lg:w-96">
                                ...
                                <input type="text" name="email" id="topbar-search"
                                    class="bg-zinc-200 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full pl-10 p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                                    placeholder="Search">
                            </div>
                        </form>
                    </div>
                    <div class="flex items-center">
                        ...
                        <div class="flex items-center ml-3">
                            ...
                            <div class="z-50 hidden my-4 text-base list-none bg-white divide-y divide-gray-100 rounded shadow dark:bg-gray-700 dark:divide-gray-600"
                                id="dropdown-2"
                                style="position: absolute; inset: 0px auto auto 0px; margin: 0px; transform: translate3d(1227px, 1461px, 0px);"
                                data-popper-placement="bottom">
                                    ...
                                    <form action="#" method="GET" class="lg:hidden">
                                        ...
                                        <div class="relative">
                                            ...
                                            <input type="text" name="email" id="mobile-search"
                                                class="bg-zinc-200 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full pl-10 p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-gray-200 dark:focus:ring-primary-500 dark:focus:border-primary-500"
                                                placeholder="Search">
                                        </div>
                                    </form>
                                </li>
