<template>
    <header>
        <nav
            class="pl-2 pr-2 ring-1 dark:ring-white/10 ring-primary/5 rounded-3xl fixed z-30 w-full bg-white dark:bg-secondary dark:border-gray-700">
            <div class="px-3 py-3 lg:px-5 lg:pl-3">
                <div class="flex items-center justify-between">
                    <div class="flex items-center justify-start">
                        <button id="toggleSidebarMobile" @click="toggleSideBar" aria-expanded="true" aria-controls="sidebar"
                            class="p-2 text-gray-600 rounded cursor-pointer lg:hidden hover:text-gray-900 hover:bg-gray-100 focus:bg-gray-100 dark:focus:bg-gray-700 focus:ring-2 focus:ring-gray-100 dark:focus:ring-gray-700 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-white">
                            <svg ref="$toggleSidebarMobileHamburger" class="w-6 h-6" fill="currentColor" viewBox="0 0 20 20"
                                xmlns="http://www.w3.org/2000/svg">
                                <path fill-rule="evenodd"
                                    d="M3 5a1 1 0 011-1h12a1 1 0 110 2H4a1 1 0 01-1-1zM3 10a1 1 0 011-1h6a1 1 0 110 2H4a1 1 0 01-1-1zM3 15a1 1 0 011-1h12a1 1 0 110 2H4a1 1 0 01-1-1z"
                                    clip-rule="evenodd"></path>
                            </svg>
                            <svg ref="$toggleSidebarMobileClose" class="hidden w-6 h-6" fill="currentColor"
                        ...
                        <NuxtLink to="/profile" class="flex ml-2 md:mr-24">
                            <NuxtImg alt="logo" src="/images/logo.svg" class="h-8 mr-3"></NuxtImg>
                        </NuxtLink>
                    ...
                    <div class="flex items-center">
                        ...
                        <div class="z-20 z-50 hidden max-w-sm my-4 overflow-hidden text-base list-none bg-white divide-y divide-gray-100 rounded shadow-lg dark:divide-gray-600 dark:bg-gray-700"
                            ...
                            style="position: absolute; inset: 0px auto auto 0px; margin: 0px; transform: translate3d(1099px, 1465px, 0px);"
                            data-popper-placement="bottom">
                            <div
                                class="block px-4 py-2 text-base font-medium text-center text-gray-700 bg-zinc-200 dark:bg-gray-700 dark:text-gray-400">
                                Notifications
                            </div>
                            <div>
                                <a href="#"
                            ...
                            <a href="#"
                                class="block py-2 text-base font-normal text-center text-gray-900 bg-zinc-200 hover:bg-gray-100 dark:bg-gray-700 dark:text-white dark:hover:underline">
                        ...
                        <div class="z-20 z-50 hidden max-w-sm my-4 overflow-hidden text-base list-none bg-white divide-y divide-gray-100 rounded shadow-lg dark:bg-gray-700 dark:divide-gray-600"
                            id="apps-dropdown"
                            style="position: absolute; inset: 0px auto auto 0px; margin: 0px; transform: translate3d(1139px, 1465px, 0px);"
                            data-popper-placement="bottom">
                            <div
                                class="block px-4 py-2 text-base font-medium text-center text-gray-700 bg-zinc-200 dark:bg-gray-700 dark:text-gray-400">
                                Apps
                        ...
                        <div id="tooltip-toggle" role="tooltip"
                            ...
                            style="position: absolute; inset: 0px auto auto 0px; margin: 0px; transform: translate3d(1106.5px, 63px, 0px);"
                            data-popper-placement="bottom">
                            Toggle dark mode
                        ...
                        <div class="flex items-center ml-3">
                            <div>
                                <button type="button" @click="isUserDropActive = !isUserDropActive"
                                    class="flex text-sm bg-gray-800 rounded-full focus:ring-4 focus:ring-gray-300 dark:focus:ring-gray-600"
                                    id="user-menu-button-2" aria-expanded="false" data-dropdown-toggle="dropdown-2">
                                    <span class="sr-only">Open user menu</span>
                                    <img class="w-8 h-8 rounded-full" :src="appConfig.api.baseUrl + '/' + auth.user.image"
                                        alt="user photo">
                                </button>
                            </div>

                            <div v-if="isUserDropActive"
                                ...
                                id="dropdown-2"
                                style="position: absolute; inset: 0px auto auto 0px; margin: 0px; top: 70px; right: 10px; left: auto;"
                                data-popper-placement="bottom">
    ...
    <div class="dark:bg-primary bg-zinc-200 flex-grow">
        <div class="flex pt-16 overflow-hidden bg-zinc-200 dark:bg-primary">
            <aside ref="$sidebar"
                class=" fixed top-0 left-0 z-20 flex flex-col flex-shrink-0 hidden w-64 h-full pt-16 font-normal duration-75 lg:flex transition-width"
                aria-label="Sidebar">
                <div class="relative flex flex-col flex-1 min-h-0 pt-0 ">
                    <div class="flex flex-col flex-1 pt-5 pb-4 pl-2 pr-2 overflow-y-auto">
                        <div
                            class="flex-1 px-3 py-2 space-y-1 bg-white divide-y divide-gray-200 dark:bg-secondary dark:divide-gray-700 ring-1 dark:ring-white/10 ring-primary/5 rounded-3xl">
            ...
            <div class="fixed inset-0 z-10 hidden bg-zinc-200 dark:bg-primary" id="sidebarBackdrop"></div>
            <div id="main-content" class="relative w-full h-full overflow-y-auto bg-zinc-200 lg:ml-64  dark:bg-primary">
                <main>
                    <slot></slot>
                </main>
...
const $toggleSidebarMobileHamburger = ref(null)
const $toggleSidebarMobileClose = ref(null)

function toggleSideBar() {
    $toggleSidebarMobileHamburger.value.classList.toggle('hidden');
    $toggleSidebarMobileClose.value.classList.toggle('hidden');
